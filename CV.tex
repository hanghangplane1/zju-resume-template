...
\setlength{\interProjectSpacing}{0.55em}
...
\vspace{0.2em}
\centerline{\normalsize{\faPhone\ 130-9832-9363 \quad \faEnvelopeO\ \href{mailto:yuhang3.25@intl.zju.edu.cn}{yuhang3.25@intl.zju.edu.cn} \quad \faBriefcase\ 求职意向：\textbf{C++开发工程师}}}


\section{\makebox[\widthof{\faGraduationCap}][c]{\color{CVBlue}\faGraduationCap}\ 教育经历}

\noindent\makebox[6.0cm][l]{\textbf{浙江大学}（985/C9）}%
\makebox[3.5cm][l]{国际联合学院}%
\makebox[2.8cm][l]{结构工程}%
工学硕士 \hfill 2025.09 -- 至今
\begin{itemize}[nosep, topsep=0.1em]
    \item 主修课程：具身智能，人工智能算法与系统，人工智能理论和高级应用，AI 赋能：创新思维引领下的产品设计
\end{itemize}
\vspace{0.3em}
\noindent\makebox[6.0cm][l]{\textbf{长安大学}（211/双一流学科）}%
\makebox[3.5cm][l]{未来交通学院}%
\makebox[2.8cm][l]{土木工程}%
工学学士 \hfill 2021.09 -- 2025.06
...
项目简介：基于 C++ 独立实现 Google A2A（Agent-to-Agent）协议的完整 SDK，利用阿里百炼平台提供的 Agent 构建多 Agent 通信系统验证协议准确性。同时利用 Redis 分布式存储对话历史保证上下文记忆，通过 tcpdump 抓包分析验证通信流程与协议格式的正确性。
\begin{itemize}[nosep, topsep=\intraProjectListTopSep]
